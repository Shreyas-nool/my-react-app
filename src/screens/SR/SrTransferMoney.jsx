...
const SrTransferMoney = () => {
  ...
  useEffect(() => {
    ...
    // Fetch SR balance from payments
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await push(ref(db, "payments"), {
        party: "Transfer",
        amount: amt, // positive for target
        bank: targetBank,
        createdAt: now,
      ...
      setAmount("");
      setNotes("");
      navigate("/sr"); // redirect back to SR index
    } catch (error) {
      console.error(error);
...
export default SrTransferMoney;
