...
const AddBank = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!bankName.trim() || !accountDetails.trim()) {
                ...
                <Card className="max-w-md mx-auto shadow-sm border-border/40">
                    ...
                    <CardContent>
                        <form className="space-y-4 pt-2" onSubmit={handleSubmit}>
                            ...
                            {/* Submit Button */}
                            <Button type="submit" className="w-full h-10 gap-2 text-sm font-semibold bg-primary hover:bg-primary/90">
